...
- Файловое хранилище (`bot/data/events.json`) подходит для прототипа; на Railway **нужен Volume** на `/app/bot/data` — см. `RAILWAY_PROJECT.md`. Для платформы с веб/ЛК — позже БД (Supabase/Postgres).
