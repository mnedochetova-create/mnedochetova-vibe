#!/usr/bin/env python3
"""Опционально: MP4 из logo.png (нужны Pillow + ffmpeg). В проде не используем — только typing."""
...
def thinking_mp4() -> None:
    ...
    if not ffmpeg:
        print("ffmpeg not found — skip MP4 (runtime uses typing only)", file=sys.stderr)
        return
    logo = _square_logo()
